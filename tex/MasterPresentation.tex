...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{aligned}
            ...
            \text{DORG2R: }&\, \dfrac{12mk^2 - 6mk -4k^3 +9k^2 - 11k}{6} &\approx 2mk^2\\
            \text{DORGKR: }&\, \dfrac{2mk^2 + k^2 - k}{2} &\approx mk^2
        \end{aligned}
        $$
        We see an improvement for a factor of $2$, which is non-negligible, but we should note that the sizes
    ...
    \begin{frame}
        ...
        \begin{center}
            \includegraphics[width=.7\textwidth]{figures/timeDORGQR.pdf}
