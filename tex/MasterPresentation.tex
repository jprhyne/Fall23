...
\begin{document}
    ...
    \begin{frame}
        ...
        $$
        \begin{aligned}
            \text{DLARFT: }&\,  \frac{2mn^2 + n^3 - 2m - n}{6}&\approx \frac{mn^2}{3}\\
            \text{DLARFT\_REC: }&\, \frac{2mn^2 + n^3 - 2m - n}{6}&\approx \frac{mn^2}{3}\\
        ...
        as recursive as we are using highly optimized BLAS routines for most of these computations.
    \end{frame}
    %\end{framefont}
    \section{DLARFB}
    \begin{frame}
    ...
    \begin{frame}
        ...
        If we refer back to the algorithm of DLARFB, we can take advantage in our first step having $C_2=I$. So 
        ...
        \begin{algorithmic}[1]
            ...
            \State $C_1 =     - V_1C_1$
        \end{algorithmic}
        This saves a DGEMM call and thus saving $2(mnk - nk^2)$ operations!
    \end{frame}
    \section{DORG2R}
